...
TEMPLATE_FILE = BASE_DIR / "v10_page_template.html"
...
KEYWORD_CSV = BASE_DIR / "v10_keywords_added.csv"
REPORT_CSV = BASE_DIR / "v10_run_report.csv"
SUMMARY_JSON = BASE_DIR / "v10_run_summary.json"
...
def load_template() -> str:
    if not TEMPLATE_FILE.exists():
        raise FileNotFoundError(
            f"v10_page_template.html이 없습니다: {TEMPLATE_FILE}"
        )
...
def main() -> int:
    ...
    log("=" * 72)
    log("V10 SEO Incremental Engine")
