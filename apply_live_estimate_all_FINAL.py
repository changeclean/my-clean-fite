...
def patch(p):
    ...
    if "cc-fast-estimate" not in s:
        ...
        if x in s:s=s.replace(x,'<div class="cc-top-actions">'+x+'<a class="cc-fast-estimate" href="#estimate">⚡ 빠른 견적문의</a></div>',1)
