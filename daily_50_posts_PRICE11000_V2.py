...
.live-box{{margin:22px 0 30px;border:1px solid #dbeafe;border-radius:18px;overflow:visible;box-shadow:0 10px 28px rgba(15,23,42,.08);background:#fff}}
.live-head{{background:#075fce;color:#fff;padding:14px 18px;font-size:19px;font-weight:900}}
.live-window{{height:260px;overflow:visible;cursor:pointer;position:relative}}
